...
1. Upload the plugin files to the `/wp-content/plugins/cwr-testimonial-block` directory, or install the plugin through the WordPress plugins screen directly.
